...
# "C:\\Users\\Elina\\mpru-analysis\\testrun.txt"
...
plt.hist(kE, weights=weight, bins= 500, label = f'Tot counts {len(kE)}', color='indianred', edgecolor = 'black')
...
plt.hist(kE, weights=weight, bins= 400, label = f'Total counts {len(kE)} \nThickness 500 µm', color='indianred')
...
axs[0].hist(px, weights=weight, bins= 40, label='px \n500 µm', color='indianred')
axs[0].set_xlabel('Unit Momentum Vector in X')
axs[0].set_ylabel('Weighted #protons')
axs[0].legend()
axs[1].hist(py, weights=weight, bins= 40, label='py \n500 µm', color='indianred')
axs[1].set_xlabel('Unit Momentum Vector in Y')
axs[1].legend()
axs[2].hist(pz, weights=weight, bins= 40, label='pz \n500 µm', color='indianred')
...
plt.hist(kE_p, weights=weight_p, bins= 400, label = f'Total counts {len(kE_p)} \nThickness 500 µm', color='indianred')
